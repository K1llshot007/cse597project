...
class ImagePaths(Dataset):
    def __init__(self, training_images_list_file, transform):
        ...
        if 'cub' in training_images_list_file:
            dataset = 'cub'
            self.root = '/scratch/abhinav597project/RAT-Diffusion'
        if 'coco' in training_images_list_file:
            dataset = 'coco'
            self.root = '/disk/yesenmao/ldm/RAT_diffusion/dataset/coco/'

        with open('/scratch/abhinav597project/RAT-Diffusion/pair_list_cub.pkl', 'rb') as f:
    ...
    def __getitem__(self, i):
        ...
        return image,text.reshape(77), path